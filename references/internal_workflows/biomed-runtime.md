---
name: biomed-runtime
description: Use local biomedical runtimes and environments, including Claude Science CLI, bundled Python/R environments, Biomni source tree, and local execution helpers. Use when running or checking local analysis environments.
category: biology
metadata:
