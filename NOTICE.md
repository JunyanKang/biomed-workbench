...
- Claude Science: local runtime adapters only
...
This repository does not vendor large upstream source trees, local Claude Science workspaces, credentials, OAuth tokens, generated artifacts, model weights, or third-party scientific datasets. Environment-dependent capabilities are represented through catalog metadata, reference pages, or environment-variable adapters.
...
Users are responsible for complying with the terms of any external database, dataset, API, model, or runtime they use through this workbench.
