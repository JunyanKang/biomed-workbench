...
The current registry contains 89 dynamically discovered modules and 90 fully evidenced compatibility rows. The release suite discovers 569 tests; these counts are observations of this revision, not monotonic quality targets.
