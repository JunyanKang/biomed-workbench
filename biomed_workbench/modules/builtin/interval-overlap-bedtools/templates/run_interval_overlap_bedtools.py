#!/usr/bin/env python3
"""Project template for intersect declared genomic interval sets.
...
MODULE_ID = 'interval-overlap-bedtools'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ()
INPUT_ARTIFACT_PORTS = ('query_intervals', 'reference_intervals')
OUTPUT_ARTIFACT_PORTS = ('overlaps',)
QUALITY_GATE_IDS = ('interval-coordinate-identity', 'interval-overlap-row-validity', 'interval-overlap-inference-scope')
