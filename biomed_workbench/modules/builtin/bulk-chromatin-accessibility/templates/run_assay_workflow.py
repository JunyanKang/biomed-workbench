...
WORKFLOWS = {'atac-seq': 'ENCODE ATAC/DNase WDL 2.2.3 in ATAC mode', 'dnase-seq': 'ENCODE ATAC/DNase WDL 2.2.3 in DNase mode'}
REQUIRED_PARAMETERS = ('assay', 'paired-end policy', 'mitochondrial and duplicate policy', 'Tn5 shift where applicable', 'blacklist', 'peak caller', 'replicate consensus', 'differential design', 'motif database', 'footprint bias correction and held-out validation')
FIGURES = ('fragment length and nucleosome pattern', 'TSS enrichment', 'mitochondrial fraction', 'FRiP', 'replicate concordance', 'peak width and annotation', 'PCA', 'differential MA and volcano', 'motif enrichment', 'bias-corrected footprint diagnostics', 'genome tracks')
