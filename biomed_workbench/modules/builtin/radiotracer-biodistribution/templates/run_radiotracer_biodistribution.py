#!/usr/bin/env python3
"""Project template for summarize radiotracer biodistribution.
...
MODULE_ID = 'radiotracer-biodistribution'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.quantitative_assays:summarize_radiotracer_biodistribution'
REQUIRED_PARAMETER_FIELDS = ('measurements',)
INPUT_ARTIFACT_PORTS = ('biodistribution_measurements',)
OUTPUT_ARTIFACT_PORTS = ('biodistribution_summary',)
QUALITY_GATE_IDS = ('biodistribution-measurement-contract', 'biodistribution-interpretation-boundary')
