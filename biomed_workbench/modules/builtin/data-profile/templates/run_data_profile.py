#!/usr/bin/env python3
"""Project template for profile structured scientific rows.
...
REQUIRED_PARAMETER_FIELDS = ('rows',)
INPUT_ARTIFACT_PORTS = ('records',)
OUTPUT_ARTIFACT_PORTS = ('profile',)
QUALITY_GATE_IDS = ('data-profile-validity',)
