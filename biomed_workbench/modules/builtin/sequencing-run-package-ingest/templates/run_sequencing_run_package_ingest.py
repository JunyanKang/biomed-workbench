#!/usr/bin/env python3
"""Version 1.0 execution reference for sequencing-run-package-ingest.
...
from biomed_workbench.capabilities.ngs_integration import ingest_sequencing_run_package

MODULE_ID = "sequencing-run-package-ingest"
...
def execute_request(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    output = ingest_sequencing_run_package(**payload)
