#!/usr/bin/env python3
"""Project template for annotate complete open reading frames.
...
MODULE_ID = 'open-reading-frame-annotation'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:annotate_open_reading_frames'
REQUIRED_PARAMETER_FIELDS = ('sequence',)
INPUT_ARTIFACT_PORTS = ('sequence',)
OUTPUT_ARTIFACT_PORTS = ('open_reading_frames',)
QUALITY_GATE_IDS = ('orf-sequence-identity', 'orf-genetic-code-contract', 'orf-claim-boundary')
