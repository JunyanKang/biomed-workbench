#!/usr/bin/env python3
"""Project template for summarize xenograft tumor growth and endpoint tgi.
...
MODULE_ID = 'xenograft-tumor-growth'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.quantitative_assays:summarize_xenograft_tumor_growth'
REQUIRED_PARAMETER_FIELDS = ('observations', 'control_group')
INPUT_ARTIFACT_PORTS = ('xenograft_observations',)
OUTPUT_ARTIFACT_PORTS = ('xenograft_growth_summary',)
QUALITY_GATE_IDS = ('xenograft-animal-longitudinal-contract', 'xenograft-tgi-interpretation-boundary')
