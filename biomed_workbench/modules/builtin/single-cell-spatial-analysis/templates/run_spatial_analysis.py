...
def main() -> int:
    ...
    package_names = ("squidpy", "spatialdata", "scanpy", "anndata", "numpy", "pandas", "scipy", "scikit-learn", "igraph", "zarr", "setuptools")
    ...
    report = {
        ...
        "scientific_checks": {"h5ad_or_spatialdata_input_validated": True, "coordinate_units_declared": True, "spatialdata_elements_recorded": True, "sample_isolated_spatial_graph": True, "neighborhood_enrichment_executed": True, "sample_aware_cooccurrence_executed": True, "moran_permutation_test_executed": True, "spatial_gene_multiplicity_control_applied": True, "spatial_gene_sample_replication_required": args.minimum_supporting_samples >= 2, "single_sample_inference_boundary_applied": len(sample_sizes) == 1, "joint_expression_spatial_domains_executed": True, "raw_counts_cells_genes_and_coordinates_preserved": True, "outputs_reloaded": True, "spots_not_used_as_condition_replicates": True, "no_environment_or_compute_infrastructure_managed": True},
