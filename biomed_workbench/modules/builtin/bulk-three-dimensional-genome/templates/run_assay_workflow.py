...
WORKFLOWS = {'hi-c': 'nf-core/hic or ENCODE Hi-C pipeline', 'micro-c': 'Micro-C compatible pair and matrix workflow', 'capture-c': 'capC-MAP 1.1.3 target-fragment interaction-profile workflow', 'hichip': 'FitHiChIP 11.0 protein-anchored loop workflow', 'plac-seq': 'FitHiChIP 11.0 protein-anchored loop workflow', 'chia-pet': 'ChIA-PET2 0.9.3 linker-aware loop workflow'}
REQUIRED_PARAMETERS = ('assay', 'restriction enzyme or fragmentation', 'valid-pair filters', 'reference', 'bin resolutions', 'matrix balance method', 'minimum contacts', 'replicate concordance', 'compartment method', 'domain and loop caller', 'assay-specific background', 'multiple-testing policy')
FIGURES = ('pair-class QC', 'cis-trans and distance-decay', 'library complexity', 'replicate concordance', 'resolution curve', 'contact map', 'compartment eigenvector', 'domain insulation', 'loop enrichment', 'aggregate peak analysis', 'differential contact diagnostics')
