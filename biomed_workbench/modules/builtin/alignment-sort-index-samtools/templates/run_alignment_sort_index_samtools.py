#!/usr/bin/env python3
"""Project template for coordinate-sort and index sam alignments.
...
MODULE_ID = 'alignment-sort-index-samtools'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('threads',)
INPUT_ARTIFACT_PORTS = ('alignments',)
OUTPUT_ARTIFACT_PORTS = ('alignment_bundle',)
QUALITY_GATE_IDS = ('sam-sort-input-integrity', 'bam-sort-index-output-integrity', 'bam-post-sort-quality-review')
