#!/usr/bin/env python3
"""Project template for summarize a biological network.
...
MODULE_ID = 'network-analysis'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:network_summary'
REQUIRED_PARAMETER_FIELDS = ('edges',)
INPUT_ARTIFACT_PORTS = ('network',)
OUTPUT_ARTIFACT_PORTS = ('network_summary',)
QUALITY_GATE_IDS = ('network-analysis-validity',)
