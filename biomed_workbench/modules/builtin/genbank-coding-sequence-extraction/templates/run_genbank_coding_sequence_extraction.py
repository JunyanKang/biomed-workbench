#!/usr/bin/env python3
"""Project template for extract annotated genbank coding sequences.
...
MODULE_ID = 'genbank-coding-sequence-extraction'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:extract_genbank_coding_sequences'
REQUIRED_PARAMETER_FIELDS = ('genbank_record', 'identifier')
INPUT_ARTIFACT_PORTS = ('genbank_record',)
OUTPUT_ARTIFACT_PORTS = ('coding_sequence_evidence',)
QUALITY_GATE_IDS = ('genbank-single-record-and-feature-contract', 'genbank-cds-interpretation-boundary')
