#!/usr/bin/env python3
"""Project template for cell migration metrics.
...
MODULE_ID = 'cell-migration-metrics'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.imaging:summarize_cell_migration_tracks'
REQUIRED_PARAMETER_FIELDS = ('tracks',)
INPUT_ARTIFACT_PORTS = ('tracks',)
OUTPUT_ARTIFACT_PORTS = ('migration_metrics',)
QUALITY_GATE_IDS = ('cell-migration-metrics-validity',)
