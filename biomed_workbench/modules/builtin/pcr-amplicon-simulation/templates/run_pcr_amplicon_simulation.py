...
MODULE_ID = 'pcr-amplicon-simulation'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:simulate_pcr_amplicons'
REQUIRED_PARAMETER_FIELDS = ('template', 'forward_primer', 'reverse_primer')
INPUT_ARTIFACT_PORTS = ('pcr_request',)
OUTPUT_ARTIFACT_PORTS = ('pcr_amplicons',)
QUALITY_GATE_IDS = ('pcr-sequence-identity', 'pcr-binding-policy', 'pcr-claim-boundary')
