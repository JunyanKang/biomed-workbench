#!/usr/bin/env python3
"""Project template for localize descriptive sequence differences.
...
MODULE_ID = 'sequence-variant-localization'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:localize_sequence_variants'
REQUIRED_PARAMETER_FIELDS = ('reference', 'query')
INPUT_ARTIFACT_PORTS = ('reference', 'query')
OUTPUT_ARTIFACT_PORTS = ('sequence_difference_events',)
QUALITY_GATE_IDS = ('sequence-difference-identity', 'sequence-difference-representation', 'sequence-difference-claim-boundary')
