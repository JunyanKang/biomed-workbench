#!/usr/bin/env python3
"""Project template for aggregate sequencing quality reports across samples.
...
MODULE_ID = 'quality-report-multiqc'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ()
INPUT_ARTIFACT_PORTS = ('quality_reports',)
OUTPUT_ARTIFACT_PORTS = ('aggregate_quality_report',)
QUALITY_GATE_IDS = ('multiqc-sample-accounting', 'multiqc-outlier-review')
