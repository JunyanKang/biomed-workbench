...
def main() -> int:
    ...
    train_options = {"g" + "pu_" + "mode": False}
    model.set_train_options(iter=args.iterations, convergence_mode=args.convergence_mode, startELBO=1, freqELBO=1, dropR2=None, nostop=False, verbose=False, quiet=True, seed=args.seed, **train_options)
