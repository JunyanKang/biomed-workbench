...
WORKFLOWS = {'wgbs': 'nf-core/methylseq and ENCODE WGBS', 'rrbs': 'nf-core/methylseq RRBS profile', 'em-seq': 'nf-core/methylseq enzymatic-conversion profile when supported'}
REQUIRED_PARAMETERS = ('assay and conversion chemistry', 'reference conversion policy', 'non-conversion control', 'duplicate policy', 'minimum coverage', 'CpG and non-CpG contexts', 'smoothing', 'DMR model and thresholds', 'biological replicate design', '5mC versus 5hmC interpretation boundary')
FIGURES = ('conversion efficiency', 'coverage distribution', 'cytosine-context composition', 'M-bias', 'replicate correlation', 'global methylation', 'PCA', 'DMR effect and significance', 'genomic annotation', 'metaprofile', 'locus tracks')
