#!/usr/bin/env python3
"""Execute pinned nf-core/methylseq 4.2.0 and reload methylation outputs."""
...
from biomed_workbench.implementations.nfcore import METHYLSEQ, execute_nfcore  # noqa: E402
