#!/usr/bin/env python3
"""Project template for fit accelerated stability and bounded arrhenius extrapolation.
...
MODULE_ID = 'accelerated-stability'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.quantitative_assays:fit_accelerated_stability'
REQUIRED_PARAMETER_FIELDS = ('observations', 'target_temperature_c', 'specification_percent')
INPUT_ARTIFACT_PORTS = ('stability_observations',)
OUTPUT_ARTIFACT_PORTS = ('stability_summary',)
QUALITY_GATE_IDS = ('stability-observation-contract', 'stability-extrapolation-boundary')
