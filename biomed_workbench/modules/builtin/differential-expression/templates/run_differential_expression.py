#!/usr/bin/env python3
"""Project template for run compact differential expression.
...
MODULE_ID = 'differential-expression'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:differential_expression'
REQUIRED_PARAMETER_FIELDS = ('genes', 'group_a', 'group_b')
INPUT_ARTIFACT_PORTS = ('expression',)
OUTPUT_ARTIFACT_PORTS = ('contrasts',)
QUALITY_GATE_IDS = ('differential-expression-validity',)
