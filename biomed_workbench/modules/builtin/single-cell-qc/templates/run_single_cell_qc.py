#!/usr/bin/env python3
"""Project template for quality-control single-cell count data.
...
REQUIRED_PARAMETER_FIELDS = ('genes', 'cells', 'matrix')
INPUT_ARTIFACT_PORTS = ('single_cell_counts',)
OUTPUT_ARTIFACT_PORTS = ('cell_quality',)
QUALITY_GATE_IDS = ('single-cell-qc-validity',)
