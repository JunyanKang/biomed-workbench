...
MODULE_ID = 'bulk-rna-modification-enrichment'
ASSAYS = ('merip-seq', 'm6a-seq')
WORKFLOWS = {'merip-seq': 'MeRIPseqPipe or exomePeak2 workflow', 'm6a-seq': 'MeRIPseqPipe or exomePeak2 workflow'}
REQUIRED_PARAMETERS = ('IP and matched input', 'antibody and lot', 'biological replicates', 'RNA type and strandedness', 'reference and transcript annotation', 'expression-aware background', 'peak caller', 'consensus rule', 'differential model', 'motif and positional analysis', 'orthogonal validation plan')
FIGURES = ('IP and input QC', 'mapping and transcript composition', 'replicate concordance', 'peak width', 'transcript metagene', 'motif enrichment', 'IP-input enrichment', 'differential MA and volcano', 'expression-versus-enrichment diagnostics', 'locus tracks')
