#!/usr/bin/env python3
"""Project template for calculate auditable tumor mutation burden.
...
MODULE_ID = 'tumor-mutation-burden'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.research_quality:calculate_tumor_mutation_burden'
REQUIRED_PARAMETER_FIELDS = ('variants', 'callable_megabases')
INPUT_ARTIFACT_PORTS = ('variants',)
OUTPUT_ARTIFACT_PORTS = ('mutation_burden',)
QUALITY_GATE_IDS = ('tumor-mutation-burden-validity',)
