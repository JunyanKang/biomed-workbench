#!/usr/bin/env python3
"""Project template for audit a golden gate assembly plan.
...
MODULE_ID = 'golden-gate-plan'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.biochemical_design:plan_golden_gate'
REQUIRED_PARAMETER_FIELDS = ('fragments',)
INPUT_ARTIFACT_PORTS = ('fragments',)
OUTPUT_ARTIFACT_PORTS = ('assembly_plan',)
QUALITY_GATE_IDS = ('golden-gate-plan-validity',)
