...
WORKFLOWS = {'rip-seq': 'RIPSeeker or count-level IP versus input enrichment with biological replicates', 'eclip': 'ENCODE eCLIP pipeline v2.2', 'iclip': 'nf-core/clipseq 1.0.0 with iCLIP-compatible UMI and site policy', 'hits-clip': 'nf-core/clipseq 1.0.0 with HITS-CLIP-compatible peak policy', 'par-clip': 'nf-core/clipseq 1.0.0 with diagnostic conversion-aware policy', 'lace-seq': 'LACE-seq paper workflow plus caochch/LACEseq commit b8d1193638190c50c8553847ad3a1653544dbe14'}
REQUIRED_PARAMETERS = ('assay', 'library layout', 'RBP and antibody', 'biological replicates', 'matched input or IgG policy', 'crosslink chemistry', 'UMI layout', 'reference and annotation', 'site or peak caller', 'replicate rule')
FIGURES = ('read and UMI accounting', 'mapping category composition', 'library complexity', 'replicate concordance', 'IP versus control enrichment', 'site or peak width and annotation', 'metaprofile', 'motif enrichment', 'genome or transcript track', 'target-validation linkage')
