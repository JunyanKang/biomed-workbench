#!/usr/bin/env python3
"""Project template for summarize aligned protein conservation.
...
MODULE_ID = 'aligned-protein-conservation'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:summarize_aligned_protein_conservation'
REQUIRED_PARAMETER_FIELDS = ('sequences',)
INPUT_ARTIFACT_PORTS = ('protein_alignment',)
OUTPUT_ARTIFACT_PORTS = ('protein_conservation_summary',)
QUALITY_GATE_IDS = ('protein-alignment-identity', 'protein-alignment-geometry', 'protein-conservation-claim-boundary')
