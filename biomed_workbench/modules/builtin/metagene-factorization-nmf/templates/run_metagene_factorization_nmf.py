#!/usr/bin/env python3
"""Project template for discover stable metagene programs with multi-start nmf.
...
MODULE_ID = 'metagene-factorization-nmf'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ()
INPUT_ARTIFACT_PORTS = ('expression_matrix',)
OUTPUT_ARTIFACT_PORTS = ('metagene_loadings', 'sample_exposures', 'factorization_report')
QUALITY_GATE_IDS = ('nmf-matrix-identity-and-semantics', 'nmf-multistart-rank-selection', 'nmf-independent-reconstruction', 'nmf-stability-and-redundancy', 'nmf-association-not-causation')
