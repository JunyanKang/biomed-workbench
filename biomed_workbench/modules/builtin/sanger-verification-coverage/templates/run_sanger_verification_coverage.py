#!/usr/bin/env python3
"""Project template for plan Sanger verification coverage.
...
MODULE_ID = 'sanger-verification-coverage'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:plan_sanger_verification_coverage'
REQUIRED_PARAMETER_FIELDS = ('template', 'target_start', 'target_end')
INPUT_ARTIFACT_PORTS = ('template',)
OUTPUT_ARTIFACT_PORTS = ('verification_plan',)
QUALITY_GATE_IDS = ('sanger-target-contract', 'sanger-coverage-accounting', 'sanger-claim-boundary')
