#!/usr/bin/env python3
"""Project template for align two biological sequences.
...
MODULE_ID = 'sequence-pairwise-alignment'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:pairwise_sequence_alignment'
REQUIRED_PARAMETER_FIELDS = ('reference', 'query')
INPUT_ARTIFACT_PORTS = ('reference', 'query')
OUTPUT_ARTIFACT_PORTS = ('pairwise_alignment',)
QUALITY_GATE_IDS = ('pairwise-sequence-identity', 'pairwise-scoring-contract', 'pairwise-claim-boundary')
