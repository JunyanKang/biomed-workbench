#!/usr/bin/env python3
"""Project template for simulate exact-match PCR amplicons.
...
MODULE_ID = 'primer-pair-specificity-screen'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:screen_primer_pair_specificity'
REQUIRED_PARAMETER_FIELDS = ('forward_primer', 'reverse_primer', 'reference_sequences', 'intended_reference_id')
INPUT_ARTIFACT_PORTS = ('reference_panel',)
OUTPUT_ARTIFACT_PORTS = ('specificity_evidence',)
QUALITY_GATE_IDS = ('specificity-panel-contract', 'specificity-product-accounting', 'specificity-claim-boundary')
