#!/usr/bin/env python3
"""Project template for build an fdr-controlled ddr coexpression hypothesis network.
...
MODULE_ID = 'ddr-coexpression-hypothesis-network'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:ddr_coexpression_hypothesis_network'
REQUIRED_PARAMETER_FIELDS = ('sample_ids', 'expression', 'ddr_genes', 'mutated_samples', 'method', 'minimum_paired_samples', 'minimum_absolute_correlation', 'false_discovery_rate')
INPUT_ARTIFACT_PORTS = ('expression_and_mutation_context',)
OUTPUT_ARTIFACT_PORTS = ('ddr_hypothesis_network',)
QUALITY_GATE_IDS = ('ddr-network-sample-alignment', 'ddr-network-multiplicity', 'ddr-network-inference-scope')
