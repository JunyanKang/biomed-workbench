#!/usr/bin/env python3
"""Project template for back-translate a protein sequence.
...
MODULE_ID = 'sequence-back-translate'
...
OUTPUT_ARTIFACT_PORTS = ('coding_sequence',)
QUALITY_GATE_IDS = ('sequence-back-translate-validity',)
