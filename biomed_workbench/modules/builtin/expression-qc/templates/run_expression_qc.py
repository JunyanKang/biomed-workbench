#!/usr/bin/env python3
"""Project template for quality-control an expression matrix.
...
MODULE_ID = 'expression-qc'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:expression_qc'
REQUIRED_PARAMETER_FIELDS = ('genes', 'samples', 'matrix')
INPUT_ARTIFACT_PORTS = ('expression',)
OUTPUT_ARTIFACT_PORTS = ('expression_quality',)
QUALITY_GATE_IDS = ('expression-qc-validity',)
