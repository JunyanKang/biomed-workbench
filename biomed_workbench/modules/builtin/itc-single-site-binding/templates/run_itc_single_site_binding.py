#!/usr/bin/env python3
"""Project template for fit one-site itc binding.
...
MODULE_ID = 'itc-single-site-binding'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.biophysics:fit_itc_single_site_binding'
REQUIRED_PARAMETER_FIELDS = ('injection_volumes_ul', 'integrated_heats_ucal', 'cell_macromolecule_um', 'syringe_ligand_um', 'cell_volume_ul')
INPUT_ARTIFACT_PORTS = ('itc_integrated_heats',)
OUTPUT_ARTIFACT_PORTS = ('itc_binding_fit',)
QUALITY_GATE_IDS = ('itc-integrated-input-contract', 'itc-fit-boundary-and-residual-review')
