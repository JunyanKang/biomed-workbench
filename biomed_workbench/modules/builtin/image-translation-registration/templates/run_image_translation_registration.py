#!/usr/bin/env python3
"""Project template for register 2D images by integer translation.
...
MODULE_ID = 'image-translation-registration'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.imaging:register_image_translation'
REQUIRED_PARAMETER_FIELDS = ('fixed', 'moving')
INPUT_ARTIFACT_PORTS = ('fixed', 'moving')
OUTPUT_ARTIFACT_PORTS = ('translation_registration',)
QUALITY_GATE_IDS = ('translation-registration-geometry', 'translation-registration-overlap', 'translation-registration-claim-boundary')
