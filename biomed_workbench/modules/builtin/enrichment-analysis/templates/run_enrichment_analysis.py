#!/usr/bin/env python3
"""Project template for run gene-set overrepresentation.
...
MODULE_ID = 'enrichment-analysis'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:enrichment_analysis'
REQUIRED_PARAMETER_FIELDS = ('query_genes', 'gene_sets', 'background_genes')
INPUT_ARTIFACT_PORTS = ('gene_sets',)
OUTPUT_ARTIFACT_PORTS = ('enrichment',)
QUALITY_GATE_IDS = ('enrichment-analysis-validity',)
