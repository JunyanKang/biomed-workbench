#!/usr/bin/env python3
"""Project template for run read-level sequencing quality control.
...
MODULE_ID = 'read-quality-fastqc'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('threads',)
INPUT_ARTIFACT_PORTS = ('reads',)
OUTPUT_ARTIFACT_PORTS = ('read_quality_report',)
QUALITY_GATE_IDS = ('fastqc-report-completeness', 'fastqc-module-status-review')
