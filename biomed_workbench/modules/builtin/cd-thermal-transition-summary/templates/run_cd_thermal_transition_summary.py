#!/usr/bin/env python3
"""Project template for summarize circular-dichroism thermal transition.
...
MODULE_ID = 'cd-thermal-transition-summary'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:summarize_cd_thermal_transition'
REQUIRED_PARAMETER_FIELDS = ('temperatures_c', 'signals')
INPUT_ARTIFACT_PORTS = ('cd_thermal_curve',)
OUTPUT_ARTIFACT_PORTS = ('cd_thermal_summary',)
QUALITY_GATE_IDS = ('cd-thermal-input-order', 'cd-thermal-transition-coverage', 'cd-thermal-claim-boundary')
