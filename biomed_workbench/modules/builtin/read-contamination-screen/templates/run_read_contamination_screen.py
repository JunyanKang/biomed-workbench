#!/usr/bin/env python3
"""Project template for screen sequencing reads against declared references.
...
MODULE_ID = 'read-contamination-screen'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('threads',)
INPUT_ARTIFACT_PORTS = ('reads', 'references')
OUTPUT_ARTIFACT_PORTS = ('contamination_report',)
QUALITY_GATE_IDS = ('screen-reference-integrity', 'screen-scope-interpretation')
