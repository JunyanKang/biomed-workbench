#!/usr/bin/env python3
"""Project template for summarize structured variants.
...
MODULE_ID = 'variant-summary'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:variant_summary'
REQUIRED_PARAMETER_FIELDS = ('variants',)
INPUT_ARTIFACT_PORTS = ('variants',)
OUTPUT_ARTIFACT_PORTS = ('variant_statistics',)
QUALITY_GATE_IDS = ('variant-summary-validity',)
