#!/usr/bin/env python3
"""Project template for fit steady-state enzyme kinetics.
...
MODULE_ID = 'enzyme-kinetics'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.biochemical_design:fit_enzyme_kinetics'
REQUIRED_PARAMETER_FIELDS = ('observations',)
INPUT_ARTIFACT_PORTS = ('kinetic_observations',)
OUTPUT_ARTIFACT_PORTS = ('kinetic_model',)
QUALITY_GATE_IDS = ('enzyme-kinetics-validity',)
