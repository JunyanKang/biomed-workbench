#!/usr/bin/env python3
"""Project template for map restriction enzyme sites.
...
OUTPUT_ARTIFACT_PORTS = ('restriction_sites',)
QUALITY_GATE_IDS = ('restriction-plan-validity',)
