#!/usr/bin/env python3
"""Project template for qualify alignment mechanics with samtools flagstat.
...
MODULE_ID = 'alignment-quality-samtools'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('threads',)
INPUT_ARTIFACT_PORTS = ('alignments',)
OUTPUT_ARTIFACT_PORTS = ('alignment_quality_report',)
QUALITY_GATE_IDS = ('alignment-bundle-integrity', 'flagstat-count-conservation', 'alignment-assay-context')
