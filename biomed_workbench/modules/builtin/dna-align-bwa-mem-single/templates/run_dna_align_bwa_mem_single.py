#!/usr/bin/env python3
"""Project template for align single-end dna reads with bwa-mem.
...
MODULE_ID = 'dna-align-bwa-mem-single'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('threads', 'sample-id')
INPUT_ARTIFACT_PORTS = ('reads', 'reference')
OUTPUT_ARTIFACT_PORTS = ('alignments',)
QUALITY_GATE_IDS = ('bwa-reference-bundle-integrity', 'bwa-sample-read-group-identity', 'bwa-alignment-not-interpretation')
