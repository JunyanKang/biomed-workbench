#!/usr/bin/env python3
"""Project template for fit declared-period cosinor rhythm.
...
MODULE_ID = 'fixed-period-cosinor'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.rhythm:fit_fixed_period_cosinor'
REQUIRED_PARAMETER_FIELDS = ('time', 'values')
INPUT_ARTIFACT_PORTS = ('time_series',)
OUTPUT_ARTIFACT_PORTS = ('cosinor_summary',)
QUALITY_GATE_IDS = ('cosinor-sampling-and-period-contract', 'cosinor-model-boundary-review')
