#!/usr/bin/env python3
"""Project template for validate and summarize RNA secondary structure.
...
MODULE_ID = 'rna-secondary-structure-summary'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:summarize_rna_secondary_structure'
REQUIRED_PARAMETER_FIELDS = ('dot_bracket',)
INPUT_ARTIFACT_PORTS = ('rna_structure',)
OUTPUT_ARTIFACT_PORTS = ('rna_structure_summary',)
QUALITY_GATE_IDS = ('rna-structure-notation', 'rna-structure-sequence-consistency', 'rna-structure-claim-boundary')
