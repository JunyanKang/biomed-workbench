#!/usr/bin/env python3
"""Project template for run independent fastq quality metrics with fastp.
...
QUALITY_GATE_IDS = ('fastp-qc-only-accounting', 'fastp-metric-review')
