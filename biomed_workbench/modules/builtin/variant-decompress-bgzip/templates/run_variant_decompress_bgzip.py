#!/usr/bin/env python3
"""Project template for decompress indexed bgzf vcf without changing records.
...
MODULE_ID = 'variant-decompress-bgzip'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ()
INPUT_ARTIFACT_PORTS = ('variants',)
OUTPUT_ARTIFACT_PORTS = ('decompressed_variants',)
QUALITY_GATE_IDS = ('vcf-bgzf-input-bundle-integrity', 'vcf-bgzf-roundtrip-integrity', 'vcf-bgzf-representation-scope')
