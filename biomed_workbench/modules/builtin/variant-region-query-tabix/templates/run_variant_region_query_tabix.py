#!/usr/bin/env python3
"""Project template for retrieve indexed vcf records by genomic region.
...
MODULE_ID = 'variant-region-query-tabix'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('region',)
INPUT_ARTIFACT_PORTS = ('variants',)
OUTPUT_ARTIFACT_PORTS = ('regional_variants',)
QUALITY_GATE_IDS = ('tabix-vcf-bundle-integrity', 'tabix-vcf-region-output-integrity', 'tabix-vcf-inference-scope')
