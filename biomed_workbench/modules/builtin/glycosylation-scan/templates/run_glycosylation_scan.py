#!/usr/bin/env python3
"""Project template for scan protein glycosylation contexts.
...
MODULE_ID = 'glycosylation-scan'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.biochemical_design:scan_glycosylation'
REQUIRED_PARAMETER_FIELDS = ('protein',)
INPUT_ARTIFACT_PORTS = ('protein',)
OUTPUT_ARTIFACT_PORTS = ('glycosylation_contexts',)
QUALITY_GATE_IDS = ('glycosylation-scan-validity',)
