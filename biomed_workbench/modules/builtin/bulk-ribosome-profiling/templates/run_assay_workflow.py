...
ASSAYS = ('ribo-seq',)
WORKFLOWS = {'ribo-seq': 'nf-core/riboseq 1.2.0'}
REQUIRED_PARAMETERS = ('library adapter and UMI layout', 'rRNA and tRNA depletion references', 'genome and transcript annotation', 'read-length range', 'P-site offset policy', 'periodicity threshold', 'start-codon policy', 'ORF classes', 'minimum ORF support', 'paired RNA-seq design', 'translational-efficiency contrast')
FIGURES = ('read-length distribution', 'contaminant depletion', 'mapping composition', 'P-site offset diagnostics', 'frame periodicity by length', 'start and stop metagene', 'ORF-class counts', 'caller agreement', 'gene and ORF abundance', 'translational-efficiency MA and volcano', 'browser tracks')
