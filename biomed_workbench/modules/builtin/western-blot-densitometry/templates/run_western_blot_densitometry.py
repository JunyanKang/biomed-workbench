#!/usr/bin/env python3
"""Project template for quantify reviewed western blot bands.
...
MODULE_ID = 'western-blot-densitometry'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.quantitative_assays:summarize_western_blot_densitometry'
REQUIRED_PARAMETER_FIELDS = ('measurements', 'reference_lane_ids')
INPUT_ARTIFACT_PORTS = ('reviewed_blot_rois',)
OUTPUT_ARTIFACT_PORTS = ('western_blot_summary',)
QUALITY_GATE_IDS = ('western-blot-reviewed-roi-contract', 'western-blot-interpretation-boundary')
