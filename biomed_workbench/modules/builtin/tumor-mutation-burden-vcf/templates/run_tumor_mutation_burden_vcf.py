#!/usr/bin/env python3
"""Project template for calculate tmb from filtered vcf and callable bed territory.
...
MODULE_ID = 'tumor-mutation-burden-vcf'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ()
INPUT_ARTIFACT_PORTS = ('variants', 'callable_territory')
OUTPUT_ARTIFACT_PORTS = ('mutation_burden',)
QUALITY_GATE_IDS = ('tmb-vcf-bed-identity', 'tmb-callable-union-denominator', 'tmb-ann-alt-consequence', 'tmb-clinical-scope')
