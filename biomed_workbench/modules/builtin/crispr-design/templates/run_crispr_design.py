#!/usr/bin/env python3
"""Project template for discover crispr guide candidates.
...
MODULE_ID = 'crispr-design'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.molecular:crispr_guides'
REQUIRED_PARAMETER_FIELDS = ('sequence',)
INPUT_ARTIFACT_PORTS = ('target_sequence',)
OUTPUT_ARTIFACT_PORTS = ('guides',)
QUALITY_GATE_IDS = ('crispr-design-validity',)
