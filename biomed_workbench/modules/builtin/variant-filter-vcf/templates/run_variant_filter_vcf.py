#!/usr/bin/env python3
"""Project template for filter biallelic vcf records with explicit evidence rules.
...
MODULE_ID = 'variant-filter-vcf'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'scientific-command'
REQUIRED_PARAMETER_FIELDS = ('minimum_quality', 'minimum_depth', 'minimum_allele_fraction', 'genes', 'require_pass', 'missing_metric_policy')
INPUT_ARTIFACT_PORTS = ('variants',)
OUTPUT_ARTIFACT_PORTS = ('filtered_variants', 'filter_report')
QUALITY_GATE_IDS = ('vcf-filter-input-integrity', 'vcf-filter-missing-metric-policy', 'vcf-filter-output-accounting', 'vcf-filter-inference-scope')
