#!/usr/bin/env python3
"""Project template for compare multi-sample variant states without collapsing missingness.
...
MODULE_ID = 'multi-sample-variant-concordance'
MODULE_VERSION = '1.0.0'
ENTRYPOINT = 'biomed_workbench.capabilities.omics:multi_sample_variant_concordance'
REQUIRED_PARAMETER_FIELDS = ('samples', 'variants', 'reference_build', 'reference_sequence_digest', 'normalization')
INPUT_ARTIFACT_PORTS = ('variant_state_matrix',)
OUTPUT_ARTIFACT_PORTS = ('concordance_report',)
QUALITY_GATE_IDS = ('variant-concordance-reference-identity', 'variant-concordance-callability', 'variant-concordance-phase')
