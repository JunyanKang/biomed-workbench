...
class ModuleMigrationReleaseTests(unittest.TestCase):
    ...
    def test_migration_and_compatibility_reports_prove_parity(self):
        ...
        self.assertEqual(migration["module_count"], 55)
        self.assertEqual(migration["entrypoint_parity_count"], 48)
        self.assertEqual(migration["input_schema_parity_count"], 48)
        self.assertEqual(migration["scientific_contract_complete_count"], 55)
        self.assertEqual(migration["compatibility_contract_complete_count"], 55)
        self.assertEqual(compatibility["module_count"], 55)
        self.assertEqual(compatibility["compatibility_complete"], 55)
