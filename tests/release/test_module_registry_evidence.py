...
class ModuleRegistryEvidenceTests(unittest.TestCase):
    def test_source_and_installed_registries_have_identical_verified_indexes(self):
        ...
        self.assertEqual(source["module_count"], 56)
        self.assertEqual(installed["module_count"], 56)
    ...
    def test_compatibility_evidence_counts_are_complete(self):
        ...
        self.assertEqual(
            ...
            {
                "tool_requirements": 17,
                "dependency_requirements": 64,
                "dependency_probes": 64,
                "structured_version_differences": 26,
                "input_format_contracts": 59,
                "output_format_contracts": 56,
                "compatibility_rows": 56,
                "regression_evidence_bindings": 56,
                "end_to_end_evidence_bindings": 56,
            },
        )
    ...
    def test_every_dependency_has_a_typed_probe_and_tool_differences_are_structured(self):
        ...
        self.assertEqual(len(differences), 26)
