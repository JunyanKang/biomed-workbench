...
class ModuleRegistryEvidenceTests(unittest.TestCase):
    def test_source_and_installed_registries_have_identical_verified_indexes(self):
        ...
        self.assertEqual(source["module_count"], 53)
        self.assertEqual(installed["module_count"], 53)
    ...
    def test_compatibility_evidence_counts_are_complete(self):
        ...
        self.assertEqual(
            ...
            {
                "tool_requirements": 14,
                "dependency_requirements": 61,
                "dependency_probes": 61,
                "structured_version_differences": 23,
                "input_format_contracts": 54,
                "output_format_contracts": 53,
                "compatibility_rows": 53,
                "regression_evidence_bindings": 53,
                "end_to_end_evidence_bindings": 53,
            },
        )
    ...
    def test_every_dependency_has_a_typed_probe_and_tool_differences_are_structured(self):
        ...
        self.assertEqual(len(dependencies), 61)
        ...
        self.assertEqual(len(differences), 23)
