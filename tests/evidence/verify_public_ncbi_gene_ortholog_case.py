...
def main():
    ...
    payload={"case_id":"ncbi-tp53-human-mouse-ortholog-v1","passed":observed.get("source",{}).get("gene_id")=="7157" and any(record.get("gene_id")=="22059" for record in observed.get("orthologs",[])),"module_id":"gene-ortholog-evidence","module_manifest_sha256":sha(MODULE),"source_query":{"gene_id":"7157","target_taxon_id":10090},"analysis":observed,"scientific_boundary":["This case verifies a current NCBI database ortholog record and bounded provenance.","It does not establish functional, regulatory, expression, phenotype, cell-state or experimental equivalence between TP53 and Trp53."]}
