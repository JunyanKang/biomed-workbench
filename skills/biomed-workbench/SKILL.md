...
7. Treat a protocol or configuration handoff as non-evidentiary. Add an artifact or evidence record only after observed execution and output validation; preserve failed, skipped, and not-run analyses explicitly.
