...
The registry currently contains **194** independently discoverable modules. Of these, 31 have dependency-scoped public-data acceptance and 163 have executable, output-reloading adapters without a current public-data acceptance case. The bulk layer includes RNA-seq; ChIP-seq, CUT&RUN and CUT&Tag; R-loop mapping by DRIP-seq, DRIPc-seq, sDRIP/ssDRIP-seq, qDRIP-seq, R-ChIP, MapR and sensor-declared CUT&Tag; RIP-seq, eCLIP, iCLIP, HITS-CLIP, PAR-CLIP and LACE-seq; Ribo-seq with explicit multi-caller ORF evaluation; GRO-seq, PRO-seq, TT-seq and NET-seq; ATAC-seq and DNase-seq; WGBS, RRBS and EM-seq; Hi-C, Micro-C, Capture-C, HiChIP, PLAC-seq and ChIA-PET; and MeRIP-seq/m6A-seq. Each public-data case defines the exact accepted backend, version, study design, and artifact scope.
