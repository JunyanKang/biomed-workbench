...
| Funding and research proposals | Reviews the question, overall argument, aims, feasibility evidence, independent value, and fallback strategy under an agency-, year-, and programme-specific profile | Current official form and instructions, authentic preliminary foundation, resources, and applicant material |
...
NSFC applications use a dedicated 2026 profile for Young C, Young B, Young A, General, Regional, Key and Major programmes. General and Young C use the official three-part body and 30-page principle; the other programme types require the exact current form downloaded from the NSFC Grants System. Drafting begins only after multi-source literature discovery, full-text review of central papers, citation-identity resolution, claim-evidence adjudication and project-relevant public-database retrieval. The workbench can then begin from reviewed facts, preliminary results or an existing draft, rebuild the central question, hypothesis, section argument and aims, and continue to actual proposal prose rather than stopping at a checklist. Once the body is stable, the Chinese abstract compresses the background, question, hypothesis, authentic preliminary basis, aims and expected knowledge advance within 400 Chinese characters; the English abstract is derived from it without a separate length limit and preserves the same scientific concepts and evidence strength. The entire outward-facing document is then revised paragraph by paragraph to remove engineering, audit, software-orchestration and computer-system language while preserving necessary analytical method names, parameters and quantitative facts. Rationale, hypothesis, workflow, technical-route, preliminary-foundation and achievement-lineage figures use distinct content contracts. Scientifically meaningful tissue, cellular, molecular, experimental-model and observed-data elements carry the visual story; exact labels and relations are rebuilt as editable objects and reviewed repeatedly at final insertion size. Subsequent review also covers Chinese paragraph logic, phenotype-mechanism relevance, mechanism-claim strength, biomedical nomenclature, native DOCX citation reciprocity and rendered-page delivery. See [NSFC proposal support](nsfc-proposal-writing.md).
...
Manuscript writing begins from the research canon, central question, study design, evidence boundary, reader, paper type, section job and terminology ledger. The workbench does not retain the order in which material was pasted and does not narrate results one software package, data type or significant result at a time. It first respects declared evidence dependencies, then assigns each item a scientific role: field premise, knowledge gap, discovery, source or context, mechanistic consistency, orthogonal validation, negative boundary or integration. Each paragraph advances one scientific question, and major claims remain adjacent to the effect, uncertainty, experimental unit, data, figure, table or citation that supports them. Missing evidence remains a visible author question, limitation or hypothesis rather than being concealed by fluent prose.

The integrated academic voice revision is mandatory for manuscript and proposal writing. It first identifies structural, evidentiary and prose problems, then rewrites within the same scientific content and declared structure, and finally compares the exact source and revised text. Checks cover numbers, results, equations, citations, technical terms, mechanism boundaries, paragraph and heading structure, and whether claim language exceeds the evidence. In addition to formulaic openings, promotional claims, empty emphasis, citation dumping, clause-stacked sentences and rhetorical em dashes, it detects internal and engineering language such as registries, digests, orchestration, execution layers and state transitions when these appear in outward biomedical prose. Such wording is replaced with the specific biological object, experiment, observation, inference, limitation or discriminating next step. Genuine software, algorithm, parameter and data-processing terminology remains available in computational Methods. An author sample informs sentence rhythm, connective habits, hedging and terminology but never supplies project-specific wording.

Date-versioned writing profiles distinguish the broad life-science argument expected by Nature, Cell and Science from the clinical reporting priorities of JAMA, NEJM and The Lancet, including design, analysis population, absolute effects, confidence intervals, harms and applicability where relevant. The profiles are grounded in journal author guidance and inspectable research-article structures. They constrain section jobs and information order without copying published sentences or reducing journal voice to word substitution.

Final delivery is not an in-memory review object. `biomedical-writing-delivery` reruns the scientific-argument, biomedical-language, claim-strength and content-preservation checks, then writes a non-overwriting version directory containing an HTML reading page and JSON record. The HTML page has a table of contents and direct navigation to the question, evidence order, paragraph jobs, source and revised text, unresolved findings, project files, literature DOIs and venue guidance. The file is reopened and its structure and checksums are verified before the result can be returned as deliverable.
...
- the standards version and review date used for the assessment.

Journal ranking considers scientific scope, audience, article type, and evidentiary fit. The manuscript is checked item by item against the selected journal. When a numerical requirement is unspecified or depends on the article type, it remains a manual check and cannot support a submission-ready conclusion.

The standards version is preserved with the recommendation and review so that later revisions can be compared against the same requirements. See [Journal Positioning And Manuscript Standards](../journal-standards.md).

## Scientific Figures And Manuscripts

- Specify figures from scientific conclusions, source data, uncertainty, and the validation needs of each figure part.
- Audit manuscript readiness, citation metadata, assertion coverage, temporal consistency, and claim-evidence integrity.
...
- Produce claim-linked reviewer assessments that distinguish major validity concerns from presentation issues.
...
- Create a portable black-and-white SVG method flowchart for technical-draft review.
...
These functions prepare scientific and technical material rather than legal conclusions. Formal patent language still requires review by a qualified professional.

## Checks Before Delivery

A citation marker is not proof of claim support. A completed analysis is not automatically fit for publication. Manuscript revisions are blocked when evidence is missing, structural changes are unacknowledged, reviewer comments are incompletely extracted, locations do not resolve, placeholders remain, or the revision record cannot be verified. Patent and translational outputs retain uncertainty and do not substitute for legal or regulatory review.
