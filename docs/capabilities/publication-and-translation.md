...
The integrated academic voice revision is mandatory for manuscript and proposal writing. It first identifies structural, evidentiary and prose problems, then rewrites within the same scientific content and declared structure, and finally compares the exact source and revised text. Checks cover numbers, results, equations, citations, technical terms, mechanism boundaries, paragraph and heading structure, and whether claim language exceeds the evidence. The revision removes formulaic openings, promotional claims, empty emphasis, citation dumping, clause-stacked sentences and rhetorical em dashes while preserving justified hedging, passive voice, first-person plural and formal definitions. When an author sample is supplied, it informs sentence rhythm, connective habits, hedging and terminology but never supplies project-specific wording. Delivery includes the revision, a concise change report and a content-preservation result; a failed post-revision pass cannot be delivered as final prose.
