...
The service inventory covers NCBI E-utilities and Datasets, Crossref, Europe PMC, bioRxiv, ClinicalTrials.gov, UniProt, Ensembl, Reactome, Open Targets, gnomAD, public cBioPortal, PubChem, RCSB PDB, AlphaFold DB, QuickGO, Enrichr, ARCHS4, HPO, IUPred2A, GWAS Catalog, ChEMBL, PRIDE Archive, BioStudies/ArrayExpress, ENCODE, Human Protein Atlas, and MGnify. The added discovery clients use anonymous official endpoints. Their records remain source-specific context: mapped GWAS genes are not automatically effector genes, ChEMBL activities require assay and unit harmonisation, and public omics projects require accession-level review of design, files, species and processing before reuse.
