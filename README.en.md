...
| --- | --- | --- | --- |
| State the biological question, experimental unit, available evidence, competing hypotheses, and success criteria. | Combine methods according to their input and software requirements; record versions, parameters, environment, and outputs. | Examine technical quality, statistical robustness, biological interpretation, and claim boundaries separately. | Retain, retain with caveats, rerun, switch methods, acquire data, revise the hypothesis, or stop the branch. |
